...
class Square(Rectangle):
    ...
    def __init__(self, size, x=0, y=0, id=None):
        ...
        - id: Optional identifier. If provided, passed to the Rectangle class; otherwise, generated by Rectangle.
    ...
    def __str__(self):
        """Override the __str__ method to represent the Square instance as a string."""
